...
psites <- psites%>%subset(orf%in%names(chr22_anno$trspacecds))
psites <- sample_cov_gr(psites, chr22_anno, ritpms)

knitr::kable(enframe(head(ritpms)))
knitr::kable(enframe(head(gritpms)))
```
